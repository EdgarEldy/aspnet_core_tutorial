...
namespace aspnet_core_tutorial.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerId,ProductId,Qty,total")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerId,ProductId,Qty,total")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
